...
describe("getDisplayValue()", () => {
  ...
  it("should format complex links", () => {
    const column: LinkColumn = {
      id: 78,
      ordering: 5,
      name: "variant",
      ...
      constraint: { cardinality: { from: 1, to: 0 }, deleteCascade: false },
    };

    const value = [
      {
        id: 1,
        value: ["43000132", "Robin 20 Zoll 20 Zoll 3-G", "orange matt RH 32"],
      },
      {
        id: 2,
        value: [
          "43002132",
          "Robin 20 Zoll 20 Zoll 3-G",
          "kingsblue matt RH 32",
        ],
      },
    ];
    ...
    expect(getDisplayValue()(column, value)).toEqual([
      {
        "de-DE": "43000132 Robin 20 Zoll 20 Zoll 3-G orange matt RH 32",
        "en-GB": "43000132 Robin 20 Zoll 20 Zoll 3-G orange matt RH 32",
        "en-US": "43000132 Robin 20 Zoll 20 Zoll 3-G orange matt RH 32",
      },
      {
        "de-DE": "43002132 Robin 20 Zoll 20 Zoll 3-G kingsblue matt RH 32",
        "en-GB": "43002132 Robin 20 Zoll 20 Zoll 3-G kingsblue matt RH 32",
        "en-US": "43002132 Robin 20 Zoll 20 Zoll 3-G kingsblue matt RH 32",
      },
    ]);
  });
