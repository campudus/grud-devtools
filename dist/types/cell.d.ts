...
export type SingleLangCellValue<T> = {
    value: T;
};
...
export type LinkCellValue = SingleLangCellValue<Array<CellValue & {
    id: number;
}>>;
...
export type CellValue = BooleanCellValue | ConcatCellValue | CurrencyCellValue | DateCellValue | DateTimeCellValue | GroupCellValue | LinkCellValue | NumberCellValue | RichTextCellValue | ShortTextCellValue | TextCellValue;
export {};
